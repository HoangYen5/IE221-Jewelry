...
def create_type(payload: ProducttypeCreate, user=Depends(verifyToken)):
...
def update_type(payload: ProducttypeUpdate, user=Depends(verifyToken)):
...
def delete_type(payload: dict, user=Depends(verifyToken)):
